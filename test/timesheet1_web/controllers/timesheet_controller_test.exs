defmodule Timesheet1Web.TimesheetControllerTest do
  use Timesheet1Web.ConnCase

  alias Timesheet1.Timesheets

  @create_attrs %{date: ~D[2010-04-17], hours: 42, jobId: "some jobId", status: "some status"}
  ...
  describe "update timesheet" do
    ...
    test "redirects when data is valid", %{conn: conn, timesheet: timesheet} do
      ...
      assert html_response(conn, 200) =~ "some updated jobId"
    end
